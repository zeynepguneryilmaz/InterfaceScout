...
try:
 _,res,atoms,_=ism.build_surface_residues(clean,PH); surf=[r for r in res if r['surface_exposed']]; D=ism.build_distances(surf); mp=ism.chemistry_map(surf,D,CHEM,PH)
